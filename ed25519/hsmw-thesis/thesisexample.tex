...
%
	thesis=paper,		% Layout: Sets the type of thesis and adjusts names, styles and the layout (needs to be used prior to option onesided): paper, diploma, bachelor*, master
...
%	nosecondtitle,		% Layout: Disables the second title page (english)
	compactlistof,		% Layout: Place list of figures and list of tables together on a single page
...
%	minuscaption,		% Style: Use a minus as caption label delimiter ("Figure 1-2:" instead of "Figure 1.2:")
...
%\defensedate{2022}% Defense Date (if not yet known, at least enter year as placeholder)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Needed Packages and Configurations (for this document)
...
\begin{document}
	...
	\lstinputlisting[float=htb,caption={Minimalbeispiel für eine Belegarbeit},label=lst:mwe-paper]{mwe-paper.tex}
	...
	\lstinputlisting[float=htb,caption={Minimalbeispiel für eine Abschlussarbeit},label=lst:mwe-bachelor]{mwe-bachelor.tex}
	...
	\begin{description}
		...
		%
		\item[thesis] (\textit{paper}, \textit{diploma}, \textit{bachelor}\footref{ftn:optionDefault}\textsuperscript{,}\footref{ftn:optionDefaultValue}, \textit{master}) Schaltet die Art der Vorlage um (Beleg oder Abschlussarbeit) und setzt Standardbezeichnungen und Layouteinstellungen
		...
		%
		\item[noautobuild] (\textit{true}\footref{ftn:optionDefaultValue}, \textit{false}\footref{ftn:optionDefault}) Schaltet die automatische Verarbeitung von Abkürzungs-, Glossar- und Indexeinträgen mittels \textit{makeindex} ab (manueller Programmaufruf notwendig)
		%
	...
	\hooklists[\setuptoc{lol}{leveldown,notoc}][\setuptoc{lol}{totoc}]{\lstlistoflistings}
...
\lstinputlisting[float=htb,caption={Beschreibung},label=lst:example]{example.dat}
	...
	\begin{description}
		\item[Englisches Titelblatt]\phantomsection\label{itm:englishTitle}
		...
		\item[Bibliografische Angaben]\phantomsection\label{itm:bibliographicData}
		...
		\item[Referat]\phantomsection\label{itm:abstract}
		...
		\item[Abkürzungsverzeichnis]\phantomsection\label{itm:acronyms}
		...
		\item[Vorwort]\phantomsection\label{itm:preface}
		...
		\item[Danksagung]\phantomsection\label{itm:dedication}
		...
		\item[Anhang]\phantomsection\label{itm:appendix}
		...
		\item[Glossar]\phantomsection\label{itm:glossary}
		...
		\item[Literaturverzeichnis]\phantomsection\label{itm:bibliography}
		...
		\item[Stichwortverzeichnis]\phantomsection\label{itm:index}
		...
		\item[Selbstständigkeitserklärung und eidesstattliche Erklärung]\phantomsection\label{itm:soa}
